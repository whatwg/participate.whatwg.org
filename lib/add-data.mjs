...
import * as jsonGitHubDatabase from "./helpers/json-github-database.mjs";

const { Conflict } = httpErrors;

export async function addIndividualData(privateData, publicData) {
...
export async function addEntityData(data) {
