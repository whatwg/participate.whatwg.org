...
function getIndividualInfo(body) {
  const info = {
    public: {
      ...
      gitHubID: getStringField(body, "individual-github")
    },
    private: {
...
function getEntityInfo(body) {
  const info = {
    ...
    gitHubOrganization: getStringField(body, "entity-github-organization"),
    contact1: {
      name: getStringField(body, "contact-1-name"),
      email: getStringField(body, "contact-1-email"),
      gitHubID: getStringField(body, "contact-1-github")
    }
  };
