...
module.exports = async (submitterGitHubID, repoName, pullNumber) => {
  ...
  // This is strictly speaking never observed as only routes.js invokes this with pullNumber being
  // undefined and it does not care about the target_url field. (We do not want to require the
  // argument as it seems reasonable to manually ask for the status of a GitHub ID for a given
  // repository without having to make up a pullNumber.)
  if (pullNumber) {
